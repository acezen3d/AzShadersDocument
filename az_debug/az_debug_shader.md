...
| DepthOffsetPoint      | Float(-1,1)  | 0              | The depth offset for the vertex points.                                                                                                                    |
...
| DepthOffsetVectors    | Float(-1,1)  | 0              | The depth offset for the basis vectors.                                                                                                                    |
...
| ----- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 0     | ***WorldNormal***     | If `VertexNormalMap` is applied, the displayed normals are after applying the map. Also note that if the displacement is enabled, the displayed normals are after the displacement.                                                                    |
| 1     | ***WorldTangent***    | If `VertexTangentMap` is applied, the displayed tangents are after applying the map.                                                                                                                                                                   |
