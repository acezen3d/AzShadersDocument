...
| Name                                      | Type          | Default value | Description                                                                                                                                                                                                 |
| ----------------------------------------- | ------------- | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| overtex1                                  | Texture2D(G)  | black         | *Koikatsu property*. The over texture for the nipples of the body and the lipstick of the face.                                                                                                             |
| overcolor1                                | Color         | (1,1,1,1)     | *Koikatsu property*. The `overtex1` tint color.                                                                                                                                                             |
| OverTex1BlendType                         | Integer(0,11) | 0             | *Extension property*. The `overtex1` blend type. Its value is defined by [Blend type enum for color](../common/blend_type.md#blend-type-enum-for-color). Default is ***Normal***, consistent with the game. |
| overtex2                                  | Texture2D(G)  | black         | *Koikatsu property*. The over texture for the pubic area of the body and the facial flush of the face.                                                                                                      |
| overcolor2                                | Color         | (1,1,1,1)     | *Koikatsu property*. The `overtex2` tint color.                                                                                                                                                             |
| OverTex2BlendType                         | Integer(0,11) | 0             | *Extension property*. The `overtex2` blend type. Its value is defined by [Blend type enum for color](../common/blend_type.md#blend-type-enum-for-color). Default is ***Normal***, consistent with the game. |
| overtex3                                  | Texture2D(G)  | black         | *Koikatsu property*. The over texture for the nipples (another one, not used) of the body and the eyeshadow of the face.                                                                                    |
| overcolor3                                | Color         | (1,1,1,1)     | *Koikatsu property*. The `overtex3` tint color.                                                                                                                                                             |
| OverTex3BlendType                         | Integer(0,11) | 0             | *Extension property*. The `overtex3` blend type. Its value is defined by [Blend type enum for color](../common/blend_type.md#blend-type-enum-for-color). Default is ***Normal***, consistent with the game. |
| nip                                       | Float(0,1)    | 1             | *Koikatsu property*. Enables the use of `nipsize`.                                                                                                                                                          |
| nipsize                                   | Float(0,1)    | 0.5           | *Koikatsu property*. The nip/lip size.                                                                                                                                                                      |
| nip_specular                              | Float(0,1)    | 1             | *Koikatsu property*. Controls the nip/lip specular intensity, which is defined in the `overtex1` `green` channel.                                                                                           |
| tex1mask                                  | Float(0,1)    | 1             | *Koikatsu property*. Whether to use the `red` and `green` channels of `overtex1` to mask and multiply with `overcolor1` to get the final color.                                                             |
...
| CoverColor                                | Color         | (1,1,1,1)     | *Extension property*. The `CoverTex` tint color.                                                                                                                                                            |
| CoverTexBlendType                         | Integer(0,11) | 1             | *Extension property*. The `CoverTex` blend type. Its value is defined by [Blend type enum for color](../common/blend_type.md#blend-type-enum-for-color).                                                    |
...
| OverTex1NormalMapScale                    | Float(0,1)    | 1             | *Extension property*. The `OverTex1NormalMap` scale.                                                                                                                                                        |
...
| OverTex2NormalMapScale                    | Float(0,1)    | 1             | *Extension property*. The `OverTex2NormalMap` scale.                                                                                                                                                        |
...
Whether to use the `blue` channel of the normal maps `NormalMap`, `OverTex1NormalMap`, and `OverTex2NormalMap` as their mask. This is mainly to address the issue of insufficient precision of normal maps in Material Editor, which causes flat normals to not be perfectly flat and discontinuities at seams.  
You need to make a special normal map with the `blue` channel serving as a mask. This is not the regular transparent-pink or blue-violet normal map. The application strength of the normal maps `NormalMap`, `OverTex1NormalMap`, and `OverTex2NormalMap` will be determined by the product of the `blue` channel and the corresponding scales `NormalMapScale`, `OverTex1NormalMapScale` and `OverTex2NormalMapScale`. If you're unsure about what this property does, don't use it. Enabling this with regular normal maps will result in incorrect normals.
