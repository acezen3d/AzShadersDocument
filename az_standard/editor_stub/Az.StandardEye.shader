Shader "Az/StandardEye"
{
    Properties
    {
        ...
        _isHighLight ("isHighLight", Range(0, 1)) = 0
        _expression ("expression", 2D) = "black" { }
        _exppower ("exppower", Range(0, 1)) = 1
        _ExpressionSize ("ExpressionSize", Range(0, 1)) = 0.35
        _ExpressionDepth ("ExpressionDepth", Range(-1, 1)) = 0
        _rotation ("rotation", Range(0, 1)) = 0
        // Extension / Extra
        _HighlightLevel ("HighlightLevel", Range(1, 4)) = 1
        _UseOverColor ("UseOverColor", Range(0, 1)) = 1
        [Toggle] _IgnoreOverTexUV ("IgnoreOverTexUV", Float) = 0
