...
| RimLightIntensity       | Float(0,2)   | 1             | The rim light intensity. It will be multiplied with the `rgb` values of the rim light.                                                                     |
...
| MatcapMask                 | Texture2D(L)  | white         | The matcap mask. The `red` channel is for the detail set 1; the `green` channel is for the detail set 2.                                        |
