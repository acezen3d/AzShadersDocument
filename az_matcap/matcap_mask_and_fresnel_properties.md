...
| ------------------- | ------------ | ------------- | ------------------------------------------------------------------------------- |
| MatcapMask          | Texture2D(L) | white         | The matcap mask. The `red` channel is used.                                     |
| MatcapMaskLevel     | Float(-1,1)  | 0             | The matcap mask level. -1: fully suppressed; 0: mask-defined; 1: fully applied. |
