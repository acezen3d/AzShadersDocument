...
| 🟢RimLightBlendSrc       | Integer(0,10), see [Blend mode enum](../common/blend_mode.md#blend-mode-enum) | 1             | Rim light source blend mode.                                                                                                                          |
| 🟢RimLightBlendDst       | Integer(0,10), see [Blend mode enum](../common/blend_mode.md#blend-mode-enum) | 1             | Rim light destination blend mode.                                                                                                                     |
...
| 🔴~~MatcapAddOrMultiply~~   | Integer(0,1)                                                                  |               |                                                                                                                                                |
| 🟢MatcapBlendBase           | Float(0,1)                                                                    | 0             | Determines the background color to be added during blending. 0: `black`, 1: `white`.                                                           |
| 🟢MatcapBlendSrc            | Integer(0,10), see [Blend mode enum](../common/blend_mode.md#blend-mode-enum) | 1             | Matcap source blend mode.                                                                                                                      |
| 🟢MatcapBlendDst            | Integer(0,10), see [Blend mode enum](../common/blend_mode.md#blend-mode-enum) | 1             | Matcap destination blend mode.                                                                                                                 |

### 🏷️Ring
| Name                 | Type                                                                          | Default value | Description                                                                                                                              |
| -------------------- | ----------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| 🟢Ring                | Boolean                                                                       | true          | Whether to enable the ring.                                                                                                              |
| 🟢RingMap             | Texture🌈                                                                      | white         | Ring texture, its `rgb` channels are for the color, and `alpha` channel is for the mask.                                                 |
...
| 🟢RingStyle           | Integer(0,4)                                                                  | 4             | Ring styles. See [Additional property description/RingStyle](#ringstyle).                                                                |
...
| 🟢MainLightToRing     | Vector                                                                        | (0,2,0,2)     | Blends and applies the mask of the main light to the ring. Also see [Additional property description/MainLightToRing](#mainlighttoring). |
...
| 🟢RingBlendSrc        | Integer(0,10), see [Blend mode enum](../common/blend_mode.md#blend-mode-enum) | 1             | Ring source blend mode.                                                                                                                  |
| 🟢RingBlendDst        | Integer(0,10), see [Blend mode enum](../common/blend_mode.md#blend-mode-enum) | 1             | Ring destination blend mode.                                                                                                             |
...
### RingStyle
**Value: 0**
- ***Tangent***. One ring appears along the tangent direction (camera's x-axis).

**Value: 1**
- ***Tangent2***. Two rings appear along the tangent direction (camera's x-axis).

**Value: 2**
- ***Binormal***. One ring appears along the binormal direction (camera's y-axis).

**Value: 3**
- ***Binormal2***. Two rings appear along the binormal direction (camera's y-axis).

**Value: 4**
- ***Radius***. Ring appears directly facing the camera, along the normal direction (camera's z-axis).

### MainLightToRing
- `red`: Blends the main light to the ring. Value range: $[0,1]$.  
- `green`: The power of Half Lambert to determine the range for blending the main light to the ring. Value range: $[0,\infty)$, typically $[0,10]$.
- `blue`: Applies the mask based on the main light direction to the ring. Value range: $[-1,1]$. Negative values will invert the mask.
- `alpha`: The power of Half Lambert to determine the range for masking the ring. Value range: $[0,\infty)$, typically $[0,10]$.
