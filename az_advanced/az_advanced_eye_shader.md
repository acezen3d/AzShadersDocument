...
| overtex1        | Texture2D(G) | black         | *Koikatsu property*. The over texture 1 for the upper highlight of the iris.                                |
| overcolor1      | Color        | (1,1,1,1)     | *Koikatsu property*. The `overtex1` tint color.                                                             |
| overtex2        | Texture2D(G) | black         | *Koikatsu property*. The over texture 2 for the lower highlight of the iris.                                |
...
| expression      | Texture2D(G) | black         | *Koikatsu property*. The iris expression overlay, like a heart, a star, etc.                                |
...
### HighlightLevel
The albedo boost level of the highlight areas (`overtex1` and `overtex2`). The default value is 1, which means no boosting. A value greater than 1 makes the highlight areas to be brighter than the rest of the eye.
...
### UseOverColor
Whether to use `overcolor1` and `overcolor2` to control highlight colors.
