...
- The tessellation and displacement can be affected by the custom mesh normals, with the strength masked by the `green` channel of the textures `TessSmoothMap` and `DisplaceMap`.
