...
### LiquidFoot
⚜️***Extension property***. Liquid level for the foot area, corresponding to `rb` channels of `liquidmask`.

### LiquidAll
⚜️***Extension property***. Liquid level for the all areas.

### LiquidColor
⚜️***Extension property***. Liquid color tint.

### LiquidNormalScale
⚜️***Extension property***. Liquid normal map scale.

### LiquidMetallic
⚜️***Extension property***. Liquid metallic.

### LiquidGlossiness
⚜️***Extension property***. Liquid glossiness.