...
Under normal circumstances, you don't need to touch it. It's mainly used in the skin and cloth shaders, with the following logic. However, in cases like hair shaders, `alpha_a` and `alpha_b` have no effect, and the `red` channel of this texture always takes effect.
