...
| BlurCenter    | Vector       | (0.5,0.5,0,1) | The `rg` channels represent The center of the blur in screen space; **`alpha` channel represents the blur direction: less than 0 means inward, otherwise outward.** |
